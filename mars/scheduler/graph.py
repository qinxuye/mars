...
from ..tiles import handler, IterativeChunkGraphBuilder, TileableGraphBuilder
...
class GraphActor(SchedulerActor):
    ...
    def _gen_op_key_to_chunk(self, chunk_graph):
        for c in chunk_graph:
